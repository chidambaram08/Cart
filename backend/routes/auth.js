...
const { registerUser, loginUser, logoutUser, forgotPassword, resetPassword, getUserProfile, changePassword, updateProfile, getAllUsers, getSpecificUser, getUser, updateUser, deleteUser } = require('../controllers/authController');
